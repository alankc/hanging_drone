...
class Tello(object):
    ...
    #def __init__(self, port=9000): original
    def __init__(self, port=9000, interface="wlx0c9d92b767ea", interface_ip=""): #ADD BY ALAN
        ...
        #self.sock.bind(('', self.port)) ORIGINAL

        self.sock.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1) #ADD BY ALAN
        self.sock.setsockopt(socket.SOL_SOCKET, socket.SO_BINDTODEVICE, bytes(self.__interface, 'ascii')) #ADD BY ALAN
        self.sock.bind((self.__interface_ip, self.port)) #ADD BY ALAN
    ...
    def __video_thread(self):
        ...
        port = 6038
        #sock.bind(('', port)) ORIGINAL

        sock.setsockopt(socket.SOL_SOCKET, socket.SO_BINDTODEVICE, bytes(self.__interface, 'ascii')) #ADD BY ALAN
        sock.bind((self.__interface_ip, port)) #ADD BY ALAN
